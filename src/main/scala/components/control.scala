...
class Control extends Module {
  ...
  val signals =
    ListLookup(io.opcode,
      ...
      BitPat("b0110011") -> List(     1.U,               0.U,   0.U,     0.U,     0.U,             1.U,           0.U,       1.U),  // R-format 64-bit 
      BitPat("b0010011") -> List(     2.U,               0.U,   0.U,     0.U,     2.U,             1.U,           0.U,       1.U),  // I-format 64-bit      
      BitPat("b0111011") -> List(     3.U,               0.U,   0.U,     0.U,     0.U,             1.U,           0.U,       1.U),  // R-format 32-bit 
      BitPat("b0011011") -> List(     4.U,               0.U,   0.U,     0.U,     2.U,             1.U,           0.U,       1.U),  // I-format 32-bit     
      BitPat("b0000011") -> List(     5.U,               0.U,   1.U,     0.U,     2.U,             1.U,           2.U,       1.U),  // Load    
      BitPat("b0100011") -> List(     5.U,               0.U,   2.U,     0.U,     2.U,             0.U,           0.U,       1.U),  // Store (Part 5)   
      BitPat("b1100011") -> List(     0.U,               3.U,   0.U,     0.U,     0.U,             0.U,           0.U,       1.U),  // Branch 
      BitPat("b0110111") -> List(     0.U,               0.U,   0.U,     0.U,     0.U,             1.U,           1.U,       1.U),  // lui (U-types)  
      BitPat("b0010111") -> List(     5.U,               0.U,   0.U,     1.U,     2.U,             1.U,           0.U,       1.U),  // auipc (U-types) 
      BitPat("b1101111") -> List(     5.U,               1.U,   0.U,     1.U,     1.U,             1.U,           0.U,       1.U),  // jal 
      BitPat("b1100111") -> List(     5.U,               2.U,   0.U,     1.U,     1.U,             1.U,           0.U,       1.U),  // jalr
      ) // Array
    ) // ListLookup
